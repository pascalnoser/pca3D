...
Set `axes = "full"` (or `"gizmo"`) to show which direction each PC points,
...
Colouring by a continuous variable, picking a different set of PCs, and changing the viewing angle
works the same way:
